...
public class NewKwicCommand extends Command {
    ...
    public NewKwicCommand(Server s) {
        super("nkwic [TERM] [TAGS]...", "Perform a keyword-in-context search for [TERM] /w [TAGS]... ([TERM] & [TAGS] may be regular expressions).");
        this.s = s;
